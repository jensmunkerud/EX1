...
- *Understanding networking:*The main goal is to find or create a networking module that can be used in your project, and understand both what it does and how it does it such that you are able to make proper use of it.
- *Experience with concurrency:*It is very likely that you will be using some form of concurrent execution in the project, and you will find good use for this already in this exercise.
...
3. The third part is to get introduced to some useful tools when testing networked code: remote logins, file transfers, and packet loss testing.
